...
class FirestoreService {
  ...
  Future<void> addTable(BuildContext context, String owner, int table) async {
    ...
    try {
      ...
      await tables.doc(owner).collection('today').doc('table_status').set(__table);
      await tables.doc(owner).collection('tommorow').doc('table_status').set(__table);
      await tables.doc(owner).collection('day_after').doc('table_status').set(__table);
