...
import 'package:hotel_management/services/Owner_auth.dart';
...
class Ownersignin extends StatefulWidget {
  ...
  @override
  State<Ownersignin> createState() => _LoginPageState();
}

class _LoginPageState extends State<Ownersignin> {
  ...
  void _login() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, '/ownerhomepage');
