...
class TableSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future openDialogTable() => showDialog(
          context: context,
    ...
    Future openDialogPrice() => showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: Text('Price'),
            content: SizedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Update your tables like total number of tables, cost of bookings etc.",
...
const tableSvg =
    '''<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="3" y="4" width="18" height="4" rx="1" fill="#010F07"/>
<path d="M4 8V20" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
<path d="M20 8V20" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
<path d="M9 8V20" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
<path d="M15 8V20" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
</svg>
''';
const dollarSvg =
    '''<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 2V22" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
<path d="M8 7C8 5.34315 9.34315 4 11 4H13C14.6569 4 16 5.34315 16 7C16 8.65685 14.6569 10 13 10H11C9.34315 10 8 11.3431 8 13C8 14.6569 9.34315 16 11 16H13C14.6569 16 16 14.6569 16 13" stroke="#010F07" stroke-width="2" stroke-linecap="round"/>
</svg>
''';
